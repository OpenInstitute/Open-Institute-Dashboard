...
<CENTER>
  ...
  <TR>
    ...
    <table  id='gut' width="100%" border="0" align="center" cellspacing="4" cellpadding="3">
					  ...
					  <?php	} //end while statement		?>
							...
							<table width="100%" id='gut' border="0" bgcolor=#ffffff cellspacing="0" cellpadding="0">
                             <tr> 
                                ...
                                <td width="21%" align="right"><a href="?Add=1">Add Publication</a></td>
			...
			$today = date("y-m-d");
		$query_Contents = sprintf("SELECT *	FROM publications INNER JOIN events ON publications.eventid = events.num
						ORDER BY publications.entrydate  DESC,publications.publicationname");
            ...
            <tr>
				  <td>&nbsp;</td>
				  <td><font color="#FF0000"><strong>Publication Name </strong></font></td>
				  <td ><font color="#FF0000"><strong>Function Name</strong></font> </td>
                  <td align="center">&nbsp;</td>
            </tr>
			<?php 
			$c=1;
			...
			<tr> 
			  ...
			  <td width="43%"><?php echo $row_Contents['publicationname'];?></td>
			  <td width="34%"><?php echo $row_Contents['heading'];?></td>
			  <td width="18%"><a href="?Edit=<?php echo $row_Contents['publicationid'];?>">View</a></td>
			</tr>
            <?php 
			$c++;
			}
		...
		<?php }
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="2" id='gut'>
                ...
                <tr>
                <td width="27%"><strong><font color="#FF0000">New Publication </font></strong></td>
                  <td width="73%">&nbsp;</td>
                  </tr>
		...
		<form name="form1" action="log.php" method="post" enctype="multipart/form-data">
                <tr>
                  ...
                  <td>
                <input type="text" name="publicationname" style="width:280;" value=""></td>
                  </tr>
			
                <tr>
                  <td><strong>Event Name</strong></td>
                  <td><select name="EventID"  style="width:280;" >
				  <?php events(0)?>
				  </select></td>
                  </tr>
				      <tr>
		      <td class="style4"><strong>Publication Details</strong></td>
		      <td><textarea name="publicationdetail" rows="20" id="Detail" style="width:320px"></textarea>
			    <script language="javascript1.2">generate_wysiwyg('Detail');</script>				  </td>
	    </tr>
                <tr>
                  <td><strong>Publication File </strong></td>
                  <td><input type="file" name="docurl" ></td>
                  </tr>
				  <tr>
                ...
                <tr>
                  ...
                  <td><input type="submit" name="Submit" value="Add">
                    <input type="hidden" name="formname" value="PublicationAdd"></td>
                  </tr>
</form>
              </table>
		  <?php }
			...
			$today = date("y-m-d");
			$query_Contents1 = sprintf("SELECT * FROM publications WHERE publicationid=$Edit");
			...
			?><table width="100%" border="0" cellpadding="0" cellspacing="2" id='gut'>
                ...
                <tr>
                <td width="27%"><strong><font color="#FF0000">Edit Publication </font></strong></td>
                  <td width="73%">&nbsp;</td>
                  </tr>
		...
		<form name="form1" action="log.php" method="post" enctype="multipart/form-data">
                <tr>
                  <td><strong>Publication Name</strong></td>
                  <td>
                <input type="text" name="publicationname" style="width:280;" value="<?php echo $row_Contents1['publicationname']?>"></td>
                  </tr>
			
                <tr>
                  <td><strong>Event Name </strong></td>
                  <td><select name="EventID"  style="width:280;" >
				  <?php events($row_Contents1['eventid'])?>
				  </select></td>
                  </tr>
				      <tr>
		      <td class="style4"><strong>Publication Details</strong></td>
		      <td><textarea name="publicationdetail" rows="20" id="Detail" style="width:320px"><?php echo $row_Contents1['publicationdetail']?></textarea>
			    <script language="javascript1.2">generate_wysiwyg('Detail');</script>				  </td>
	    </tr>
                <tr>
                  <td><strong>Publication file</strong></td>
                  <td><?php echo $row_Contents1['publicationfile']; ?> <input type="file" name="docurl" ></td>
                </tr>
				<tr>
                  <td><strong>Viewed</strong></td>
                ...
                <tr>
                  ...
                  <td><input type="submit" name="Submit" value="Edit">
                    <input type="hidden" name="publicationid" value="<?php echo $row_Contents1['publicationid'];?>">
                    <input type="hidden" name="formname" value="PublicationUpdate"></td>
                  </tr>
</form>
              </table>
		  <?php }?>
