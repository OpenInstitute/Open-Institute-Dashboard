...
<meta name="ProgId" content="FrontNCD.Editor.Document">
    ...
    <table  id='gut' width="100%" border="0" align="center" cellspacing="4" cellpadding="3">
					  ...
					  <?php	} //end while statement		?>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                             <tr> 
                                <td width="52%" align="left"><b>Add/Append Expertise </b></td>
		...
		//echo formname
		  ...
		  <table width="100%" border="0" cellspacing="2" cellpadding="3">
			<?php 
					//$NCDID=$_GET['NCDID'];
					$query_Links0= sprintf("SELECT * FROM expertise ORDER BY expertise");
					...
					while ($row_Contents0=mysql_fetch_array($Contents0)) {?>
                                    <tr> 
                                      <td width="57%" class="style4"><b><?php echo $row_Contents0['expertise']; ?></b></td>
                                    
                                      <td width="9%"><a href="?Edit=<?php echo $row_Contents0['expertiseid'];?>">Edit</a></td>
                                      <td width="34%" class="style4"> 
                                        <?php 
			...
			$query_Contents = sprintf("SELECT * FROM  expertise WHERE (expertiseid = $Edit)");
				//echo $query_Contents;
			...
			<form name="sampleform" action="log.php" method="post"  >
			 <tr>
                <td>
				  <fieldset>
				  <legend style="color:#9933CC"><strong>Update Expertise </strong></legend>
				  <table width="100%" border="0" cellpadding="0" cellspacing="2">
                <tr>
                  <td width="25%" class="style4"><strong>NCD Title</strong></td>
                  <td width="75%"><input name="title" type="text" id="NCDTitle" style="width:320px" value="<?php echo $row_Contents['expertise'] ?>" size="50" maxlength="200"></td>
                </tr>	
		<tr>
		  <td class="style4">Viewed</td>
		  <td >
			<input type="checkbox" name="viewed"<?php if ($row_Contents['viewed']){ ?>checked<?php } ?>> 
			<input name="formname" type="hidden" value="ExpertiseUpdate" >  
			<input name="expertiseid" type="hidden" value="<?php echo $row_Contents['expertiseid'] ?>" >
			</td>
		</tr>
                <tr>
                  <td class="style4">&nbsp;</td>
                  <td ><input style="width:320px" type="submit" value="Edit Expertise" name="submit"></td>
                </tr>
				</table>
				  </fieldset> 				</td>
				</tr>
		  ...
		  ?>
			  ...
			  <form name="sampleform" action="log.php" method="post"  >
                ...
                <tr>
				  ...
				  <legend style="color:#9933CC"><strong>Add NCD  </strong></legend>
				  
				  <table width="100%" border="0" cellpadding="0" cellspacing="2">
                <tr>
                  <td width="25%" class="style4"><strong>Expertise Name </strong></td>
                  <td width="75%"><input name="title" type="text" id="Title" style="width:320px" value="" size="50" maxlength="200"></td>
                </tr>
				<tr>
      <td align="left" class="style4">Menu Link</td>
      <td align="left" valign="top"><textarea name="detail" rows="20" id="detail" style="width:320px"></textarea>
		...
		<tr>
		  ...
		  <td >
			...
			<input name="formname" type="hidden" value="ExpertiseAdd" >  
		 </td>
		</tr>
                
                <tr>
                  <td class="style4">&nbsp;</td>
                  <td ><input style="width:320px" type="submit" value="Add Expertise" name="submit"></td>
                </tr>
				</table>         
				  </fieldset>				  
				  </td>
