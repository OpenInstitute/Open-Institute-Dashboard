...
$email="info@lusakaagreement.com";

// for ultimate security, use this instead of using the form
$recipient = $_POST['recipient']; // youremail@domain.com
//echo $recipient;
// bcc emails (separate multiples with commas (,))
$bcc = "bcharagu@qeetronics.com";

// referers.. domains/ips that you will allow forms to
// reside on.
$referers = array ('www.slcinternational.com','69.90.68.237');
//$referers = array ('www.wilomointernational.com','69.90.68.237');
...
function print_error($reason,$type = 0) {
   ...
   if ($type == "missing") {
      ...
      echo "The form was not submitted because of the following reasons:<p>";
...
function mail_it($content, $subject, $email, $recipient) {
   ...
   $headers .= "From: info@slcinternational.com\n"; //"From: ".$email."\n";
  ...
  // if ($bcc) $headers .= "Bcc: ".$bcc."\n"; 
   ...
   $message  = "Your Account has been activted.\n";
   $message .= "Please use the following password to log in.\n";
   $message .= "\n--".$_POST['Password'] ."--\n";
   $message .= "Use your email address as the User ID.\n";
   $message .= "Thank you again for visiting Wilomo International.\n";
...
// send it off
mail_it(stripslashes($content), "Account Activation", $email, $recipient);
